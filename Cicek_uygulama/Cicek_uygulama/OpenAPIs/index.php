...
<head>
  ...
  <title>localhost / localhost:3306 / stok_takip | phpMyAdmin 5.2.0</title>
  ...
  <li class="database">
    <div class="block">
      <i></i>
              <b></b>
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.c2hvcF9kYg==" data-vpath="cm9vdA==.c2hvcF9kYg==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=shop_db&lang=en"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=shop_db&lang=en" title="Structure">shop_db</a>
  ...
  <li class="last database">
    <div class="block">
      <i></i>
        ...
        <a class="expander" href="#">
          <span class="hide paths_nav" data-apath="cm9vdA==.c3Rva190YWtpcA==" data-vpath="cm9vdA==.c3Rva190YWtpcA==" data-pos="0"></span>
                    <img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus">
        </a>
          </div>
    
          <div class="block second">
                  <a href="index.php?route=/database/operations&db=stok_takip&lang=en"><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a>
              </div>

              <a class="hover_show_full" href="index.php?route=/database/structure&db=stok_takip&lang=en" title="Structure">stok_takip</a>
    ...
    <div class="clearfloat"></div>
      ...
      <div id="pma_navi_settings_container">
                  <div id="pma_navigation_settings"><div class="page_settings"><form method="post" action="index.php&#x3F;route&#x3D;&#x25;2Fdatabase&#x25;2Fstructure&amp;db&#x3D;stok_takip&amp;server&#x3D;1&amp;lang&#x3D;en" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="37232233627b4b6c4645683a6d213329">
...
registerFieldValidator('NavigationTreeTableLevel', 'validatePositiveNumber', true);
  ...
  <div id="prefs_autoload" class="alert alert-primary d-print-none hide" role="alert">
    <form action="index.php?route=/preferences/manage&lang=en" method="post" class="disableAjax">
        ...
        <input type="hidden" name="return_url" value="index.php?route=%2Fdatabase%2Fstructure&amp;db=stok_takip">
...
<nav id="server-breadcrumb" aria-label="breadcrumb">
  <ol class="breadcrumb breadcrumb-navbar">
    <li class="breadcrumb-item">
      ...
      <a href="index.php?route=/&lang=en" data-raw-text="localhost:3306" draggable="false">
        ...
        <a href="index.php?route=/database/structure&db=stok_takip&lang=en" data-raw-text="stok_takip" draggable="false">
          Database:          stok_takip
        </a>
      </li>
  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul id="topmenu" class="navbar-nav">
            ...
            <a class="nav-link text-nowrap" href="index.php?route=/database/structure&db=stok_takip&lang=en">
              <img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure
                              <span class="visually-hidden">(current)</span>
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/sql&db=stok_takip&lang=en">
              <img src="themes/dot.gif" title="SQL" alt="SQL" class="icon ic_b_sql">&nbsp;SQL
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/search&db=stok_takip&lang=en">
              <img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_b_search">&nbsp;Search
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/multi-table-query&db=stok_takip&lang=en">
              <img src="themes/dot.gif" title="Query" alt="Query" class="icon ic_s_db">&nbsp;Query
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/export&db=stok_takip&lang=en">
              <img src="themes/dot.gif" title="Export" alt="Export" class="icon ic_b_export">&nbsp;Export
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/import&db=stok_takip&lang=en">
              <img src="themes/dot.gif" title="Import" alt="Import" class="icon ic_b_import">&nbsp;Import
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/operations&db=stok_takip&lang=en">
              <img src="themes/dot.gif" title="Operations" alt="Operations" class="icon ic_b_tblops">&nbsp;Operations
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/server/privileges&db=stok_takip&checkprivsdb=stok_takip&viewing_mode=db&lang=en">
              <img src="themes/dot.gif" title="Privileges" alt="Privileges" class="icon ic_s_rights">&nbsp;Privileges
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/routines&db=stok_takip&lang=en">
              <img src="themes/dot.gif" title="Routines" alt="Routines" class="icon ic_b_routines">&nbsp;Routines
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/events&db=stok_takip&lang=en">
              <img src="themes/dot.gif" title="Events" alt="Events" class="icon ic_b_events">&nbsp;Events
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/triggers&db=stok_takip&lang=en">
              <img src="themes/dot.gif" title="Triggers" alt="Triggers" class="icon ic_b_triggers">&nbsp;Triggers
                          </a>
          </li>
                  <li class="nav-item">
            <a class="nav-link text-nowrap" href="index.php?route=/database/designer&db=stok_takip&lang=en">
...
<div id="page_settings_modal"><div class="page_settings"><form method="post" action="index.php&#x3F;route&#x3D;&#x25;2Fdatabase&#x25;2Fstructure&amp;db&#x3D;stok_takip&amp;server&#x3D;1&amp;lang&#x3D;en" class="config-form disableAjax">
  <input type="hidden" name="tab_hash" value="">
      <input type="hidden" name="check_page_refresh" id="check_page_refresh" value="">
    <input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="37232233627b4b6c4645683a6d213329">
...
<input type="hidden" name="db" value="stok_takip"><input type="hidden" name="lang" value="en"><input type="hidden" name="token" value="37232233627b4b6c4645683a6d213329">
<div class="table-responsive">
<table class="table table-light table-striped table-hover table-sm w-auto data">
    <thead class="table-light">
        <tr>
            <th class="d-print-none"></th>
            <th><a href="index.php?route=/database/structure&lang=en&db=stok_takip&pos=0&sort=table&sort_order=DESC&lang=en" title="Sort" onmouseover="$(&#039;.sort_arrow&#039;).toggle();" onmouseout="$(&#039;.sort_arrow&#039;).toggle();">Table <img src="themes/dot.gif" title="" alt="Ascending" class="icon ic_s_asc sort_arrow"> <img src="themes/dot.gif" title="" alt="Descending" class="icon ic_s_desc sort_arrow hide"></a></th>
            
                                                                                            <th colspan="7" class="d-print-none">
                Action            </th>
                        <th>
                <a href="index.php?route=/database/structure&lang=en&db=stok_takip&pos=0&sort=records&sort_order=DESC&lang=en" title="Sort">Rows</a>
                <span class="pma_hint"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_help"><span class="hide">May be approximate. Click on the number to get the exact count. See <a href="./doc/html/faq.html#faq3-11" target="documentation">FAQ 3.11</a>.</span></span>
                            ...
                            <th><a href="index.php?route=/database/structure&lang=en&db=stok_takip&pos=0&sort=type&sort_order=ASC&lang=en" title="Sort">Type</a></th>
                <th><a href="index.php?route=/database/structure&lang=en&db=stok_takip&pos=0&sort=collation&sort_order=ASC&lang=en" title="Sort">Collation</a></th>
            
                                            <th><a href="index.php?route=/database/structure&lang=en&db=stok_takip&pos=0&sort=size&sort_order=DESC&lang=en" title="Sort">Size</a></th>
                                <th><a href="index.php?route=/database/structure&lang=en&db=stok_takip&pos=0&sort=overhead&sort_order=DESC&lang=en" title="Sort">Overhead</a></th>
    ...
    <tbody>
            <tr id="row_tbl_1" data-filter-row="KATEGORIBILGILERI">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
            value="kategoribilgileri"
            id="checkbox_tbl_1">
    </td>
    <th>
        <a href="index.php?route=/sql&db=stok_takip&table=kategoribilgileri&pos=0&lang=en" title="">
            kategoribilgileri
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="a39d707c9f7d5cf961021995af698178_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=stok_takip&ajax_request=1&favorite_table=kategoribilgileri&add_favorite=1&lang=en"
    title="Add to Favorites"
    data-favtargets="70f3cf6119fe7cd9457f26efc7a5edbc">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=stok_takip&table=kategoribilgileri&pos=0&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_bd_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=stok_takip&table=kategoribilgileri&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=stok_takip&table=kategoribilgileri&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_bd_select">&nbsp;Search</span>
            ...
            <a href="index.php?route=/table/change&db=stok_takip&table=kategoribilgileri&lang=en"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=kategoribilgileri&sql_query=TRUNCATE+%60kategoribilgileri%60&message_to_show=Table%2Bkategoribilgileri%2Bhas%2Bbeen%2Bemptied.&lang=en">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_bd_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=kategoribilgileri&reload=1&purge=1&sql_query=DROP+TABLE+%60kategoribilgileri%60&message_to_show=Table+kategoribilgileri+has+been+dropped.&lang=en">
            ...
            data-table="kategoribilgileri">
                ...
                <a href="index.php?route=/table/structure&db=stok_takip&table=kategoribilgileri&lang=en#showusage">
            ...
            <tr id="row_tbl_2" data-filter-row="MARKABILGILERI">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
            value="markabilgileri"
            id="checkbox_tbl_2">
    </td>
    <th>
        <a href="index.php?route=/sql&db=stok_takip&table=markabilgileri&pos=0&lang=en" title="">
            markabilgileri
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="28d7c358f07ed0a21c23f7acbdaaf8ff_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=stok_takip&ajax_request=1&favorite_table=markabilgileri&add_favorite=1&lang=en"
    title="Add to Favorites"
    data-favtargets="c52d921c2db318c97a329710dc8e2d77">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=stok_takip&table=markabilgileri&pos=0&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_bd_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=stok_takip&table=markabilgileri&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=stok_takip&table=markabilgileri&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_bd_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=stok_takip&table=markabilgileri&lang=en"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=markabilgileri&sql_query=TRUNCATE+%60markabilgileri%60&message_to_show=Table%2Bmarkabilgileri%2Bhas%2Bbeen%2Bemptied.&lang=en">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_bd_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=markabilgileri&reload=1&purge=1&sql_query=DROP+TABLE+%60markabilgileri%60&message_to_show=Table+markabilgileri+has+been+dropped.&lang=en">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="markabilgileri">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=stok_takip&table=markabilgileri&lang=en#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
            ...
            <tr id="row_tbl_3" data-filter-row="MÜŞTERI">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=stok_takip&table=m%C3%BC%C5%9Fteri&pos=0&lang=en" title="">
            müşteri
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="088167f9f188f986fd26ca30cc5fcfb0_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=stok_takip&ajax_request=1&favorite_table=m%C3%BC%C5%9Fteri&add_favorite=1&lang=en"
    title="Add to Favorites"
    data-favtargets="84073b71d8ecfd53ee5ea1b5685565f7">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=stok_takip&table=m%C3%BC%C5%9Fteri&pos=0&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_bd_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=stok_takip&table=m%C3%BC%C5%9Fteri&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=stok_takip&table=m%C3%BC%C5%9Fteri&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_bd_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=stok_takip&table=m%C3%BC%C5%9Fteri&lang=en"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=m%C3%BC%C5%9Fteri&sql_query=TRUNCATE+%60m%C3%BC%C5%9Fteri%60&message_to_show=Table%2Bm%25C3%25BC%25C5%259Fteri%2Bhas%2Bbeen%2Bemptied.&lang=en">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_bd_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=m%C3%BC%C5%9Fteri&reload=1&purge=1&sql_query=DROP+TABLE+%60m%C3%BC%C5%9Fteri%60&message_to_show=Table+m%C3%BC%C5%9Fteri+has+been+dropped.&lang=en">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="müşteri">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=stok_takip&table=m%C3%BC%C5%9Fteri&lang=en#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
            ...
            <tr id="row_tbl_4" data-filter-row="SATIS">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=stok_takip&table=satis&pos=0&lang=en" title="">
            satis
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="b8ebba22101b8cde60d31447dcf1ada7_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=stok_takip&ajax_request=1&favorite_table=satis&add_favorite=1&lang=en"
    title="Add to Favorites"
    data-favtargets="3104cb698349e211f6b43034b531b480">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=stok_takip&table=satis&pos=0&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_bd_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=stok_takip&table=satis&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=stok_takip&table=satis&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_bd_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=stok_takip&table=satis&lang=en"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=satis&sql_query=TRUNCATE+%60satis%60&message_to_show=Table%2Bsatis%2Bhas%2Bbeen%2Bemptied.&lang=en">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_bd_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=satis&reload=1&purge=1&sql_query=DROP+TABLE+%60satis%60&message_to_show=Table+satis+has+been+dropped.&lang=en">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="satis">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=stok_takip&table=satis&lang=en#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
            ...
            <tr id="row_tbl_5" data-filter-row="SEPET">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=stok_takip&table=sepet&pos=0&lang=en" title="">
            sepet
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="64318b744f2dfb22fc9b93211d1bacf0_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=stok_takip&ajax_request=1&favorite_table=sepet&add_favorite=1&lang=en"
    title="Add to Favorites"
    data-favtargets="471c93d8a8e9b51f27153361ddae413e">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=stok_takip&table=sepet&pos=0&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_bd_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=stok_takip&table=sepet&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=stok_takip&table=sepet&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_bd_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=stok_takip&table=sepet&lang=en"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=sepet&sql_query=TRUNCATE+%60sepet%60&message_to_show=Table%2Bsepet%2Bhas%2Bbeen%2Bemptied.&lang=en">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_bd_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=sepet&reload=1&purge=1&sql_query=DROP+TABLE+%60sepet%60&message_to_show=Table+sepet+has+been+dropped.&lang=en">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="sepet">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=stok_takip&table=sepet&lang=en#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
            ...
            <tr id="row_tbl_6" data-filter-row="URUN">
    <td class="text-center d-print-none">
        <input type="checkbox"
            name="selected_tbl[]"
            class="checkall"
    ...
    <th>
        <a href="index.php?route=/sql&db=stok_takip&table=urun&pos=0&lang=en" title="">
            urun
        </a>
                ...
                <td class="text-center d-print-none">
                                    <a id="c73b4bb9bc43a86625fd4edf0b51c879_favorite_anchor"
    class="ajax favorite_table_anchor"
    href="index.php?route=/database/structure/favorite-table&db=stok_takip&ajax_request=1&favorite_table=urun&add_favorite=1&lang=en"
    title="Add to Favorites"
    data-favtargets="b2f28267b6536bfc128b07bebeddd1cd">
    <span class="text-nowrap"><img src="themes/dot.gif" title="" alt="" class="icon ic_b_no_favorite">&nbsp;</span>
</a>
        </td>
    
    <td class="text-center d-print-none">
        <a href="index.php?route=/sql&db=stok_takip&table=urun&pos=0&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Browse" alt="Browse" class="icon ic_bd_browse">&nbsp;Browse</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/structure&db=stok_takip&table=urun&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Structure" alt="Structure" class="icon ic_b_props">&nbsp;Structure</span>
        </a>
    </td>
    <td class="text-center d-print-none">
        <a href="index.php?route=/table/search&db=stok_takip&table=urun&lang=en">
          <span class="text-nowrap"><img src="themes/dot.gif" title="Search" alt="Search" class="icon ic_bd_select">&nbsp;Search</span>
        </a>
    </td>

            <td class="insert_table text-center d-print-none">
            <a href="index.php?route=/table/change&db=stok_takip&table=urun&lang=en"><span class="text-nowrap"><img src="themes/dot.gif" title="Insert" alt="Insert" class="icon ic_b_insrow">&nbsp;Insert</span></a>
        </td>
                  <td class="text-center d-print-none">
                <a class="truncate_table_anchor ajax" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=urun&sql_query=TRUNCATE+%60urun%60&message_to_show=Table%2Burun%2Bhas%2Bbeen%2Bemptied.&lang=en">
                  <span class="text-nowrap"><img src="themes/dot.gif" title="Empty" alt="Empty" class="icon ic_bd_empty">&nbsp;Empty</span>
                </a>
          </td>
                <td class="text-center d-print-none">
            <a class="ajax drop_table_anchor" href="index.php?route=/sql&lang=en" data-post="db=stok_takip&table=urun&reload=1&purge=1&sql_query=DROP+TABLE+%60urun%60&message_to_show=Table+urun+has+been+dropped.&lang=en">
                <span class="text-nowrap"><img src="themes/dot.gif" title="Drop" alt="Drop" class="icon ic_b_drop">&nbsp;Drop</span>
            </a>
        </td>
            ...
            data-table="urun">
                    ...
                    <td class="value tbl_size font-monospace text-end">
                <a href="index.php?route=/table/structure&db=stok_takip&table=urun&lang=en#showusage">
                    <span>16.0</span>&nbsp;<span class="unit">KiB</span>
                </a>
            </td>
            <td class="value tbl_overhead font-monospace text-end">
    ...
    <th class="tbl_num text-nowrap">
        ...
        <th>
                    ...
                    utf8_general_ci
                                    ...
                                    <th class="value tbl_size font-monospace text-end">96.0 KiB</th>
...
<div class="modal fade" id="bulkActionModal" data-bs-backdrop="static" data-bs-keyboard="false"
  ...
  <p class="d-print-none">
    ...
    <a href="index.php?route=/database/data-dictionary&db=stok_takip&goto=index.php%3Froute%3D%2Fdatabase%2Fstructure%26lang%3Den&lang=en">
  ...
  <div class="card-body row row-cols-lg-auto g-3">
    ...
    <div class="col-12 align-self-lg-end">
      ...
      <a href="index.php?route=%2Fdatabase%2Fstructure&amp;db=stok_takip&amp;server=1&amp;lang=en" title="Open new phpMyAdmin window" target="_blank" rel="noopener noreferrer">
